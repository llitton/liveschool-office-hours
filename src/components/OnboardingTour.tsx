...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description:
      'Click "Create New Event" to set up a booking type. Choose from Quick Start templates or create a custom event. For team scheduling, try Round-Robin to automatically distribute bookings across your team.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      'For teams, use Round-Robin events to automatically distribute bookings. Set host priorities so senior team members get meetings first, or use Load Balanced for even distribution.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
