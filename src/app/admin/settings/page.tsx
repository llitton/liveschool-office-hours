        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-[#667085] mt-1">
                Set your regular hours when you&apos;re available for bookings
              </p>
            </div>
              ...
              <div className="text-center py-8">
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4 text-left">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-amber-800">No availability configured</p>
                      <p className="text-sm text-amber-700 mt-1">
                        Your 1:1 and round-robin events won&apos;t show any bookable times until you set your weekly availability.
                      </p>
                    </div>
                  </div>
                </div>
                <p className="text-[#667085]">Click below to add availability for specific days</p>
              </div>
            )}
