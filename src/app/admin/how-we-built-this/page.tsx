...
const featureCategories = [
  {
    ...
    features: [
      ...
      { name: 'Session deletion', desc: 'Permanently delete test or unwanted sessions and all their bookings' },
    ],
  },
  {
    id: 'team',
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Session health metrics', desc: 'Average rating and attendance rate in event details header' },
      { name: 'Collapsible past sessions', desc: 'Accordion view for past sessions with only most recent expanded' },
      { name: 'Semantic status pills', desc: 'Green=Attended, red=No-show, amber=Unmarked on session headers' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Automated test suite', desc: '768 tests covering auth, email templates, validation, routing, iCal, SMS, Slack, attendee management, slot deletion, and booking logic' },
      ...
      { name: 'Performance optimizations', desc: 'Parallel API calls, query caching, and payload optimization for faster page loads' },
    ],
  },
];
...
const tools = [
  ...
  },
  {
    ...
    description: '768 automated tests verify every feature works. Like a robot QA team checking for bugs.',
    color: '#729B1B',
    bgColor: '#F7FEE7',
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
